	...
	<center>
		...
		<table width="90%" height="80%" border="0" cellspacing="1" cellpadding="3" align="center">
			<tr valign="top" align="center">
				...
				<td>Agent Code:
					<?php echo "$row2->Agent_code"; ?>
				</td>
				<td>Customer Number:
					<?php echo "$row1->Customer_Num"; ?>
				</td>
				<td>Customer Name:
					<?php echo "$row1->First_Name $row1->Middle_Name $row1->Last_Name"; ?>
			</tr>
			...
			<tr valign="top" align="center">
				...
				<td>Sum Assured:
					<?php echo "$row->Sum_Assured"; ?> Rs.
				</td>
				<td>Payment Period:
					<?php echo "$row->Pay_Period"; ?> Yrs.
				</td>
				<td>Insurance Period:
					<?php echo "$row->Ins_Period"; ?> Yrs.
				</td>
			</tr>
			<tr valign="top" align="center">
				<td>Marital Status:
					<?php if ($row1->Marital_status == 'M') {
						echo "Married";
					} else {
						echo "UnMarried";
					} ?>
			...
			<tr valign="top" align="center">
				<td>Mother:
					<?php echo "$row1->Mother_Name"; ?>[
					<?php if ($row1->Mother_Status == 'D') {
						echo "Dead";
					} else {
						echo "Alive";
					} ?>]
				...
				<td>Father:
					<?php echo "$row1->Father_Name"; ?>[
					<?php if ($row1->Father_Status == 'D') {
						echo "Dead";
					} else {
						echo "Alive";
					} ?>]
